class Setting < ActiveRecord::Base
  ...
  STANDARD_KEYS =  %w(page_title_short page_title tagline posts_per_page flickr_user flickr_api_key flickr_shared_secret flickr_front_page_tag flickr_blog_images_tag post_more_separator akismet_key disqus_shortname flickr_url twitter_url facebook_url google_plus_url)
