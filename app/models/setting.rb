class Setting < ActiveRecord::Base
  ...
  STANDARD_KEYS =  %w(page_title_short page_title flickr_user flickr_api_key flickr_shared_secret flickr_front_page_tag flickr_blog_images_tag portfolio_tags post_more_separator akismet_key flickr_url twitter_url facebook_url google_plus_url)
